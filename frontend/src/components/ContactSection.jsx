    ...
    >
      ...
      <div className="mt-12 text-center">
        <p className="text-gray-400 text-sm">
          You can also reach me directly at: <a href="mailto:your.email@example.com" className="text-purple-400 hover:text-purple-300 underline">yaredadisu5@gmail.com</a>
        </p>
      </div>
    </motion.section>
  );
